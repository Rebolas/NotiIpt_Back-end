...
namespace NotiIpt.Data.Migrations
{
    ...
    [Migration("20240608193639_Terceira")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotiIpt.Models.Categorias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotiIpt.Models.Fotos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotiIpt.Models.Noticias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotiIpt.Models.Utilizadores", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FotosNoticias", b =>
                {
                    b.HasOne("NotiIpt.Models.Fotos", null)
                        .WithMany()
                        .HasForeignKey("ListaFotosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NotiIpt.Models.Noticias", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NotiIpt.Models.Noticias", b =>
                {
                    b.HasOne("NotiIpt.Models.Categorias", "Categoria")
